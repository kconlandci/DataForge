#!/usr/bin/env npx tsx
// ============================================================
// DataForge - Lab Scaffold Generator
...
${scenarios},
  ...
  hints: [
    "TODO: Hint 1 â€” general guidance",
    "TODO: Hint 2 â€” more specific pointer",
    "TODO: Hint 3 â€” strongest hint without giving answer away",
  ],
...
`;
  ...
  console.log(`\nâœ… Lab skeleton created at src/data/labs/${slug}.ts`);
